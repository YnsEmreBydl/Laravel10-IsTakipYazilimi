        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('projeEklePost')}}" method="post">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="ad" placeholder="Proje adı giriniz">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Not Ekle</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <div class="col-sm-3">
                    <button type="submit" class="btn btn-primary">Yeni Proje Ekle</button>
                  </div>
                </div>
