...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Hosting Listesi</h1><br>
      <nav>
        <ol class="breadcrumb">
          <td ><a href="{{route('hosting')}}">  <button type="submit" class="btn btn-success btn-sm">Devam Eden Hostingler</button> </a></td>

          <td><a href="{{route('hostingsuresibitmis')}}">  <button style="margin-left:10px" type="submit" class="btn btn-warning btn-sm">Süresi Bitmiş Hostingler</button> </a></td>
          <td ><a href="{{route('hostingekle')}}"> <button style="margin-left:10px" type="submit" class="btn btn-primary btn-sm">Hosting Ekle</button> </a></td>
    ...
    <section class="section">
      <div class="row">
        <table class="table table-striped table-responsive">
          ...
          <tbody>
            @foreach($hostingler as $host)
              @foreach($host->hostingmusteri as $ad)
              @if($host->hostingstatus == 2)
            <tr>
              <td>{{$host->id}}</td>
